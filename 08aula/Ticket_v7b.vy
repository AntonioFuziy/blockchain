...
# Guardar os preços pagos por cada um
...
def buy():
    ...
    # Guardar o preço real pago
    self.prices[msg.sender] = self.price
...
def cancel():
    ...
    self.count -= 1
    # Devolve 80% do dinheiro PAGO (todos os valores tem que ser inteiros)
    send(msg.sender, self.prices[msg.sender]*80/100)
